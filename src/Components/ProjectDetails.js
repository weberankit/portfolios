...
<div className="w-screen aspect-video   absolute text-white  bg-gradient-to-r from-black top-0 ">
  ...
  <p className={` text-${ind.mainColor} ml-12 sm:ml-24 bg-black font-bold p-2 rounded-lg text-xs sm:text-sm fixed`}>{ind.main} <span className={`text-${ind.subColor}`}> {ind.sub}</span> </p>
{
